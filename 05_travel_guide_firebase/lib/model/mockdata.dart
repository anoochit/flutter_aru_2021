...
addMockupData() {
  var userList = [
    {
      "name": "User01",
      "image":
          "https://raw.githubusercontent.com/anoochit/flutter_aru_2021/master/04_travel_guide_full/assets/images/user01.png"
    },
    {
      "name": "User02",
      "image":
          "https://raw.githubusercontent.com/anoochit/flutter_aru_2021/master/04_travel_guide_full/assets/images/user02.png"
    },
    {
      "name": "User03",
      "image":
          "https://raw.githubusercontent.com/anoochit/flutter_aru_2021/master/04_travel_guide_full/assets/images/user03.png"
    },
    {
      "name": "User04",
      "image":
          "https://raw.githubusercontent.com/anoochit/flutter_aru_2021/master/04_travel_guide_full/assets/images/user04.png"
    },
    {
      "name": "User05",
      "image":
          "https://raw.githubusercontent.com/anoochit/flutter_aru_2021/master/04_travel_guide_full/assets/images/user05.png"
    },
    {
      "name": "User06",
      "image":
          "https://raw.githubusercontent.com/anoochit/flutter_aru_2021/master/04_travel_guide_full/assets/images/user06.png"
    },
    {
      "name": "User07",
      "image":
          "https://raw.githubusercontent.com/anoochit/flutter_aru_2021/master/04_travel_guide_full/assets/images/user07.png"
    }
  ];
  ...
  var cityList = [
    {
      ...
      "image":
          "https://raw.githubusercontent.com/anoochit/flutter_aru_2021/master/04_travel_guide_full/assets/images/city01.png"
    },
    {
      "name": "Sydney",
      "country": "Australia",
  ...
  userList.forEach((element) {
    FirebaseFirestore.instance
        .collection('users')
        .doc(element['name'].toLowerCase().replaceAll(' ', '_'))
        .set(
      {
        "name": element['name'],
        "image": element['image'],
  ...
  cityList.forEach((element) {
    FirebaseFirestore.instance
        .collection('cities')
        .doc(element['country'].toLowerCase().replaceAll(' ', '_') +
            '_' +
